...
var CustomButton = function (_a) {
    ...
    return React.createElement(ButtonBase, __assign$3({}, restProps));
};
...
var VARIANTS = {
    primary: css(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject$6(["\n    background-color: ", ";\n    transition-property: background-color, color;\n    border-color: ", ";\n\n    &:hover {\n      background-color: ", ";\n      border-color: ", ";\n    }\n  "], ["\n    background-color: ", ";\n    transition-property: background-color, color;\n    border-color: ", ";\n\n    &:hover {\n      background-color: ", ";\n      border-color: ", ";\n    }\n  "])), colors.primary.fill, colors.primary.fill, darken(colors.primary.fill, 0.1), darken(colors.primary.fill, 0.1)),
    secondary: css(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject$6(["\n    background-color: ", ";\n    border-color: ", ";\n\n    &:hover {\n      background-color: ", ";\n      border-color: ", ";\n    }\n  "], ["\n    background-color: ", ";\n    border-color: ", ";\n\n    &:hover {\n      background-color: ", ";\n      border-color: ", ";\n    }\n  "])), colors.secondary.fill, colors.secondary.fill, darken(colors.secondary.fill, 0.1), darken(colors.secondary.fill, 0.1)),
    tertiary: css(templateObject_4 || (templateObject_4 = __makeTemplateObject$6(["\n    background-color: ", ";\n    border-color: ", ";\n    color: ", ";\n\n    &:hover {\n      background-color: ", ";\n      border-color: ", ";\n    }\n  "], ["\n    background-color: ", ";\n    border-color: ", ";\n    color: ", ";\n\n    &:hover {\n      background-color: ", ";\n      border-color: ", ";\n    }\n  "])), colors.tertiary.fill, colors.tertiary.fill, colors.tertiary.text, darken(colors.tertiary.fill, 0.1), darken(colors.tertiary.fill, 0.1)),
};
var SIZES = {
    md: css(templateObject_5 || (templateObject_5 = __makeTemplateObject$6(["\n    font-size: 14px;\n    padding: 8px 24px;\n  "], ["\n    font-size: 14px;\n    padding: 8px 24px;\n  "]))),
    lg: css(templateObject_6 || (templateObject_6 = __makeTemplateObject$6(["\n    font-size: ", "px;\n    padding: 12px 24px;\n  "], ["\n    font-size: ", "px;\n    padding: 12px 24px;\n  "])), function (props) { return props.theme.typography.fontSize; }),
};
var ROUNDED = css(templateObject_7 || (templateObject_7 = __makeTemplateObject$6(["\n  border-radius: 500px;\n"], ["\n  border-radius: 500px;\n"])));
var OUTLINED = {
    primary: css(templateObject_8 || (templateObject_8 = __makeTemplateObject$6(["\n    background-color: transparent;\n    color: ", ";\n    &:hover {\n      color: ", ";\n      background-color: ", ";\n      border-color: ", ";\n    }\n  "], ["\n    background-color: transparent;\n    color: ", ";\n    &:hover {\n      color: ", ";\n      background-color: ", ";\n      border-color: ", ";\n    }\n  "])), colors.primary.fill, darken(colors.primary.fill, 0.1), lighten(colors.primary.fill, 0.95), darken(colors.primary.fill, 0.1)),
    secondary: css(templateObject_9 || (templateObject_9 = __makeTemplateObject$6(["\n    background-color: transparent;\n    color: ", ";\n    &:hover {\n      color: ", ";\n      background-color: ", ";\n      border-color: ", ";\n    }\n  "], ["\n    background-color: transparent;\n    color: ", ";\n    &:hover {\n      color: ", ";\n      background-color: ", ";\n      border-color: ", ";\n    }\n  "])), colors.secondary.fill, darken(colors.secondary.fill, 0.1), lighten(colors.secondary.fill, 0.95), darken(colors.secondary.fill, 0.1)),
    tertiary: '',
};
var BLOCK = css(templateObject_10 || (templateObject_10 = __makeTemplateObject$6(["\n  width: 100%;\n"], ["\n  width: 100%;\n"])));
var BLOCK_XS = css(templateObject_11 || (templateObject_11 = __makeTemplateObject$6(["\n  ", " {\n    width: 100%;\n  }\n"], ["\n  ", " {\n    width: 100%;\n  }\n"])), function (props) { return props.theme.breakpoints.down('xs'); });
...
var CustomTypography = function (_a) {
    ...
    return React__default.createElement(Typography$1, __assign$2({}, restProps));
};
...
var slabStyles = css(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject$5(["\n  font-family: ", ", serif;\n  font-weight: ", ";\n  font-style: italic;\n"], ["\n  font-family: ", ", serif;\n  font-weight: ", ";\n  font-style: italic;\n"])), function (_a) {
    var theme = _a.theme;
...
var FormControl = function (_a) {
    ...
    var childrenWithProps = React__default.Children.map(children, function (child) {
        if (React__default.isValidElement(child)) {
            return React__default.cloneElement(child, { error: error, disabled: disabled, required: required });
        }
        return child;
    });
    ...
    return (React__default.createElement(FormWrapper, { className: classes.join(' ') }, childrenWithProps));
};
...
var FormHelperText = function (_a) {
    ...
    return (React__default.createElement(StyledTypography, __assign$1({ variant: "caption" }, restProps), children));
};
var StyledTypography = styled(Typography)(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject$3(["\n  display: block;\n  margin-left: ", "px;\n  margin-top: ", "px;\n\n  ", "\n\n  ", "\n  \n  ", "\n"], ["\n  display: block;\n  margin-left: ", "px;\n  margin-top: ", "px;\n\n  ", "\n\n  ", "\n  \n  ", "\n"])), function (props) { return props.theme.spacing(1.5); }, function (props) { return props.theme.spacing(0.5); }, function (_a) {
    var error = _a.error;
    return error && css(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject$3(["\n      color: ", ";\n    "], ["\n      color: ", ";\n    "])), function (props) { return props.theme.palette.error.main; });
}, function (_a) {
    var disabled = _a.disabled;
    return disabled && css(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject$3(["\n      color: ", ";\n    "], ["\n      color: ", ";\n    "])), function (props) { return props.theme.palette.grey[500]; });
}, spacing);
...
var Input = function (_a) {
    ...
    return (React__default.createElement(BasePhoneInput, __assign({ specialLabel: specialLabel }, props)));
};
var PhoneInput = styled(Input)(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject$1(["\n  .react-tel-input,\n  .form-control {\n    background-color: ", ";\n    font-family: ", ";\n    font-weight: ", ";\n    font-size: ", ";\n    line-height: ", ";\n    border: 1px solid ", ";\n    border-radius: ", "px;\n    padding: ", ";\n    width: 100%;\n\n    &::placeholder {\n      color: ", ";\n    }\n\n    &:hover {\n      border: 1px solid ", ";\n    }\n\n    &:active,\n    &:focus,\n    &:focus-visible {\n      border: 1px solid ", ";\n      outline: none;\n      box-shadow: unset;\n    }\n\n    &:disabled {\n      background-color: ", ";\n      border-color: ", ";\n      color: ", ";\n    }\n\n    ", "\n  }\n"], ["\n  .react-tel-input,\n  .form-control {\n    background-color: ", ";\n    font-family: ", ";\n    font-weight: ", ";\n    font-size: ", ";\n    line-height: ", ";\n    border: 1px solid ", ";\n    border-radius: ", "px;\n    padding: ", ";\n    width: 100%;\n\n    &::placeholder {\n      color: ", ";\n    }\n\n    &:hover {\n      border: 1px solid ", ";\n    }\n\n    &:active,\n    &:focus,\n    &:focus-visible {\n      border: 1px solid ", ";\n      outline: none;\n      box-shadow: unset;\n    }\n\n    &:disabled {\n      background-color: ", ";\n      border-color: ", ";\n      color: ", ";\n    }\n\n    ", "\n  }\n"])), function (props) { return props.theme.palette.text.disabled; }, function (props) { return props.theme.typography.fontFamily; }, function (props) { return props.theme.typography.body1.fontWeight; }, function (props) { return props.theme.typography.body1.fontSize; }, function (props) { return props.theme.typography.body1.lineHeight; }, function (props) { return props.theme.palette.text.disabled; }, function (props) { return props.theme.spacing(1); }, function (props) { return props.theme.spacing(1.5, 1.5, 1.5, 7.25); }, function (props) { return props.theme.palette.grey[400]; }, function (props) { return props.theme.palette.grey[400]; }, function (props) { return props.theme.palette.grey[600]; }, function (props) { return props.theme.palette.grey[100]; }, function (props) { return props.theme.palette.grey[100]; }, function (props) { return props.theme.palette.grey[400]; }, function (_a) {
    var error = _a.error;
    return error && css(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject$1(["\n        border-color: ", ";\n      "], ["\n        border-color: ", ";\n      "])), function (props) { return props.theme.palette.error.main; });
});
