...
import React__default, { useRef, useDebugValue, useContext, createElement, Children, isValidElement, cloneElement } from 'react';
...
var Typography$1 = /*#__PURE__*/React.forwardRef(function Typography(props, ref) {
...
var CustomButton = function (_a) {
    ...
    return React__default.createElement(ButtonBase$1, __assign({}, restProps));
};
...
var CustomTypography = function (_a) {
    ...
    return React__default.createElement(MuiTypography, __assign({}, restProps));
};
...
var FormHelperText = function (_a) {
    ...
    return (React__default.createElement(StyledTypography, __assign({ variant: "caption" }, restProps), children));
};
